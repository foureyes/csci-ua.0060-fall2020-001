...
# Assignment #6 - Database Design - Due Thursday, Nov 7th  at 11pm
...
2. Normalize the data from previous assignments 
	...
	3. Attempt to manually insert _some_ data to test model
	4. Write queries against the inserted data
