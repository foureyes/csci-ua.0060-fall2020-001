...
# Assignment #1 - Bits and Snakes - Due Wednesday, Sep 16th at 11pm
...
### Membership to Course Organization on GitHub 

1. Create (or use an existing) account on GitHub
	* the email and username you use can be _non-identifying_ if you prefer not to use name, netid, etc.
2. Submit your GitHub username in the [1st class survey (see the link in the course schedule)](../)
3. Monitor your email for an invite to the GitHub organization for the course, and accept the invite 
	* this invite will be sent a day prior to the 2nd class
	* remember to check your spam folder!

###  Use Git to Clone the Repository

Make sure you have git / a git client! These clients are listed in order of ease-of-use:

* [GitHub Desktop](https://desktop.github.com/) - an easy-to-use graphical git client made by GitHub
...
* [commandline git](https://git-scm.com/book/en/v1/Getting-Started-Installing-Git) - commandline git client
...
### Running Tests 
 ...
 ⚠️ ⚠️ ⚠️  First , __there's an error in  `test_bits.py` , please correct  the line `from bits import BitList, DecodeError, ChunkError` by removing `, DecodeError, ChunkError`.
